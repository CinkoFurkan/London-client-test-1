...
const Complete = () => {
  ...
  const { data } = useFetch(`${process.env.REACT_APP_API_URL}/payment/api/order_summary`);
  const { postData } = usePost(
    `${process.env.REACT_APP_API_URL}/payment/api/order_complete`,
  ...
  const postOrder = async () => {
    try {
      await axios.post(`${process.env.REACT_APP_API_URL}/payment/api/add_order_to_db`, {
